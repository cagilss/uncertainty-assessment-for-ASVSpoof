...
class LSTMNeuralNetwork(nn.Module):
    ...
    def __init__(self): 
        ...
        self.lstm = nn.LSTM(input_size=90, hidden_size=8, num_layers=4, batch_first=True, bidirectional=True, dropout=0)  

        self.main = nn.Sequential(
                
                nn.Linear(in_features=4480,  out_features=512), # 2016
                #nn_ard.LinearARD(in_features=4480, out_features=512), # 2016
                ...
                #nn_ard.LinearARD(in_features=256, out_features=128),
        ...
        #self.logits = nn_ard.LinearARD(in_features=128, out_features=2)
    ...
    def init_weight(self):
        for m in self.modules():
            if isinstance(m, nn_ard.LinearARD):
