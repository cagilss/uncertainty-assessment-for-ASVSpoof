...
class ELBOLoss(nn.Module):
    ...
    def forward(self, logits, tensor_y, loss_weight=1., kl_weight=1.):
        assert not tensor_y.requires_grad
        # Estimate ELBO
        return loss_weight * self.loss_fn(logits, tensor_y) + kl_weight * get_ard_reg(self.net)
